...
export const gradientBgPurplePink = `${gradientBgBase} from-purple-400 via-pink-500 to-[#E53F49]`;
...
export const getButtonColor = (
  ...
  const colors = {
    ...
    bg: {
      ...
      whiteDark: "bg-[#FDFDFD] text-black dark:bg-slate-900 dark:text-[#FDFDFD]",
